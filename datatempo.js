...
//         diaSeguinte.setMonth(this.getMonth()-1);
//         diaSeguinte.setDate(this.getDate()+1);
//         console.log(">> ", diaSeguinte)
//         return diaSeguinte;
//     }

//     diaAnterior() {
//         let diaAnt = new Data();
//         diaAnt.setFullYear(this.getFullYear());
//         diaAnt.setMonth(this.getMonth());
//         diaAnt.setDate(this.getDate());
//         console.log("<< ", diaAnt)
//         return diaAnt;
//     }
// }
